...
const EditPage = () => {
  ...
  const [form, setForm] = useState({
    ...
    riskScore: "", owner: "", dueDate: "", lastReviewedDate: "",
  });
  ...
  useEffect(() => {
    if (control) {
      setForm({
        ...
        lastReviewedDate: control.lastReviewedDate || "",
      });
    }
  }, [control]);
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea name="description" value={form.description} onChange={handleChange}
                rows={3} className="w-full border border-gray-300 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 resize-none"
              />
